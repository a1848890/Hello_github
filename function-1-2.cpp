...
/*
 * because the pointer is a block of memory pointing to an object. change the pointer can lead to the change of
 * the original object.
 *
 * reference is non-changable, pointer is changable
 * */
